package ru.cargoonline.server.component;
...
public class TimeLogger {
    ...
    public Object logDataSyncTime(ProceedingJoinPoint joinPoint) throws Throwable
    {
        ...
        logger.info("{} iteration processing time: {} mls, total processed: {}", iterationCounter.incrementAndGet(), timeSpent, ret);
